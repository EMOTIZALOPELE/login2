...
<head>
    ...
    <title>VECOPO - Cambiar Nombre de Usuario</title>
...
<body>
    <main class="login-container">
        ...
        <form action="<?= base_url('update-username') ?>" method="post">
<<<<<<< HEAD
            <input type="hidden" name="<?= csrf_token() ?>" value="<?= csrf_hash() ?>">
=======
>>>>>>> 3c34e82b0f649c57139357adfb0935563a96df95
            <div class="form-group">
                <label for="identifier" class="form-label">Email o Usuario Actual</label>
                <input class="form-control-custom" type="text" name="identifier" id="identifier" 
                        placeholder="Tu email o usuario actual" 
            ...
            <div class="form-group">
                ...
                <div class="password-input-container">
                    <input class="form-control-custom" type="password" name="password" id="password" 
                            placeholder="Tu contraseña para confirmar" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control-custom" type="text" name="new_username" id="new_username" 
                        placeholder="Elige tu nuevo nombre de usuario" 
                        value="<?= old('new_username') ?>" required> 
            </div>
            
            <button class="login-button" type="submit">Actualizar Nombre</button>
