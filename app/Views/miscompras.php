                    ...
                    <div class="card-body p-4">
                        ...
                        <form id="envioForm">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="pais" name="pais" placeholder="Ej: Argentina" required>
                            </div>
                            
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    <label for="provincia" class="form-label">Provincia / Estado</label>
                                    <input type="text" class="form-control" id="provincia" name="provincia" placeholder="Ej: Córdoba" required>
                                </div>
                                
                                <div class="col-md-6 form-group">
                                    <label for="ciudad" class="form-label">Ciudad</label>
                                    <input type="text" class="form-control" id="ciudad" name="ciudad" placeholder="Ej: Río Tercero" required>
                                </div>
                            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#envioForm').on('submit', function(e) {
                ...
                // Si CodeIgniter está configurado para no incluir el token en serializeArray() 
                ...
                if (!purchases || purchases.length === 0) {
                    container.html(`
                        <div class="no-purchases">
                            ...
                            <div class="mt-4">
                                <a href="<?= base_url('/seleccionar-plan') ?>" class="btn btn-comprar">
