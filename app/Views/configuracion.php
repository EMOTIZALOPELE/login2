...
<body>
    <div class="config-card">
        ...
        <form action="<?= base_url('configuracion/guardar') ?>" method="POST" id="configForm">
            ...
            <div class="content-block" id="ventana_block">
                ...
                <div class="form-group">
                    ...
                    <input type="time" id="ventana_apertura" name="open_hour_ventana" class="form-control-time" 
                           value="<?= esc($horarios['ventana_apertura'] ?? '') ?>" 
                           placeholder="Dejar vacío para desactivar">
                </div>
                <div class="form-group">
                    <label for="ventana_cierre">Cierre:</label>
                    <input type="time" id="ventana_cierre" name="close_hour_ventana" class="form-control-time" 
                           value="<?= esc($horarios['ventana_cierre'] ?? '') ?>" 
                           placeholder="Dejar vacío para desactivar">
                </div>
                <h3>Condicionantes</h3>
                <div class="form-group">
                    <label for="min_temp_ventana">Temp. Mínima (°C):</label>
                    <input type="number" id="min_temp_ventana" name="min_temp_ventana" class="form-control-input" step="0.1" 
                           value="<?= esc($condicionantes['ventana']['temp_min'] ?? '') ?>" 
                           placeholder="Dejar vacío para desactivar">
                </div>
                <div class="form-group">
                    <label for="max_temp_ventana">Temp. Máxima (°C):</label>
                    <input type="number" id="max_temp_ventana" name="max_temp_ventana" class="form-control-input" step="0.1" 
                           value="<?= esc($condicionantes['ventana']['temp_max'] ?? '') ?>" 
                           placeholder="Dejar vacío para desactivar">
                </div>
                <div class="form-group">
                    <label for="max_wind_speed_ventana">Viento Máx. (m/s):</label>
                    <input type="number" id="max_wind_speed_ventana" name="max_wind_speed_ventana" class="form-control-input" step="0.1" 
                           value="<?= esc($condicionantes['ventana']['velocidad_viento_max'] ?? '') ?>" 
                           placeholder="Dejar vacío para desactivar">
                </div>
            ...
            <div class="content-block" id="cortina_block">
                ...
                <div class="form-group">
                    ...
                    <input type="time" id="cortina_apertura" name="open_hour_cortina" class="form-control-time" 
                           value="<?= esc($horarios['cortina_apertura'] ?? '') ?>" 
                           placeholder="Dejar vacío para desactivar">
                </div>
                <div class="form-group">
                    <label for="cortina_cierre">Cierre:</label>
                    <input type="time" id="cortina_cierre" name="close_hour_cortina" class="form-control-time" 
                           value="<?= esc($horarios['cortina_cierre'] ?? '') ?>" 
                           placeholder="Dejar vacío para desactivar">
                </div>
                <h3>Condicionantes</h3>
                <div class="form-group">
                    <label for="min_temp_cortina">Temp. Mínima (°C):</label>
                    <input type="number" id="min_temp_cortina" name="min_temp_cortina" class="form-control-input" step="0.1" 
                           value="<?= esc($condicionantes['cortina']['temp_min'] ?? '') ?>" 
                           placeholder="Dejar vacío para desactivar">
                </div>
                <div class="form-group">
                    <label for="max_temp_cortina">Temp. Máxima (°C):</label>
                    <input type="number" id="max_temp_cortina" name="max_temp_cortina" class="form-control-input" step="0.1" 
                           value="<?= esc($condicionantes['cortina']['temp_max'] ?? '') ?>" 
                           placeholder="Dejar vacío para desactivar">
                </div>
                <div class="form-group">
                    <label for="max_wind_speed_cortina">Viento Máx. (m/s):</label>
                    <input type="number" id="max_wind_speed_cortina" name="max_wind_speed_cortina" class="form-control-input" step="0.1" 
                           value="<?= esc($condicionantes['cortina']['velocidad_viento_max'] ?? '') ?>" 
                           placeholder="Dejar vacío para desactivar">
                </div>
                <div class="form-group checkbox-group">
            ...
            <div class="content-block" id="postigon_block">
                ...
                <div class="form-group">
                    ...
                    <input type="time" id="postigon_apertura" name="open_hour_postigon" class="form-control-time" 
                           value="<?= esc($horarios['postigon_apertura'] ?? '') ?>" 
                           placeholder="Dejar vacío para desactivar">
                </div>
                <div class="form-group">
                    <label for="postigon_cierre">Cierre:</label>
                    <input type="time" id="postigon_cierre" name="close_hour_postigon" class="form-control-time" 
                           value="<?= esc($horarios['postigon_cierre'] ?? '') ?>" 
                           placeholder="Dejar vacío para desactivar">
                </div>
                <h3>Condicionantes</h3>
                <div class="form-group">
                    <label for="min_temp_postigon">Temp. Mínima (°C):</label>
                    <input type="number" id="min_temp_postigon" name="min_temp_postigon" class="form-control-input" step="0.1" 
                           value="<?= esc($condicionantes['postigon']['temp_min'] ?? '') ?>" 
                           placeholder="Dejar vacío para desactivar">
                </div>
                <div class="form-group">
                    <label for="max_temp_postigon">Temp. Máxima (°C):</label>
                    <input type="number" id="max_temp_postigon" name="max_temp_postigon" class="form-control-input" step="0.1" 
                           value="<?= esc($condicionantes['postigon']['temp_max'] ?? '') ?>" 
                           placeholder="Dejar vacío para desactivar">
                </div>
                <div class="form-group">
                    <label for="max_wind_speed_postigon">Viento Máx. (m/s):</label>
                    <input type="number" id="max_wind_speed_postigon" name="max_wind_speed_postigon" class="form-control-input" step="0.1" 
                           value="<?= esc($condicionantes['postigon']['velocidad_viento_max'] ?? '') ?>" 
                           placeholder="Dejar vacío para desactivar">
                </div>
                <div class="form-group checkbox-group">
            ...
            <div class="content-block" id="hourly_forecast_block">
                ...
                <div class="hourly-forecast-container">
                    <div class="hourly-forecast-grid" id="hourly_forecast_grid"></div>
                </div>
            </div>
    ...
    <script>
        ...
        // ===== CÓDIGO EXISTENTE PARA EL CLIMA =====
